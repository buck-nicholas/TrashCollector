...
namespace TrashCollectorWebApp.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Amount,TransactionCompleted,CustomerID")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Amount,TransactionCompleted,CustomerID")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
